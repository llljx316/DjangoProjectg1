# Generated by Django 3.2.15 on 2024-06-08 03:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Name', models.CharField(max_length=30, verbose_name='用户名字')),
                # ('Password', models.CharField(max_length=30, verbose_name='密码')),
                ('UserType', models.CharField(max_length=20, verbose_name='用户类型')),
                ('Gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female')], max_length=1, verbose_name='性别')),
                ('Age', models.IntegerField(verbose_name='年龄')),
                ('Phone', models.CharField(max_length=20, verbose_name='电话')),
                ('IDNumber', models.CharField(max_length=20, verbose_name='身份信息')),
